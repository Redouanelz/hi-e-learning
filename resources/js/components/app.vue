            ...
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item" v-if="isAuthenticated">
                <router-link
                  ...
                  class="nav-link"
                  to="/profile"
                  ><i class="bi bi-person-circle"></i>  <b>{{ user.name }}</b> <span class="badge bg-primary">{{ user.role }}</span>
    ...
    <footer style="margin-top:100px;margin-bottom:100px;">
      ...
      <div class="container">
        ...
        <div class="col-md-4">
          ...
          <br>
          <h4>Hi</h4> 
          <h5>E-learning plateform</h5>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe illum eius voluptatibus, excepturi itaque, quam velit vitae sequi nobis voluptatum tempore nesciunt earum quasi a dicta aut dolores iste animi?</p>
        </div>
        <div class="col-md-3">
